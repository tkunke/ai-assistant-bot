  ...
  return (
    <div className="relative text-center" style={{ width: "100vw", height: "100vh", backgroundImage: `url(${screenOrientation === 'portrait' ? portraitBackground : landscapeBackground})` }}>
      <header className="header" style={{ backgroundColor: 'transparent' }}>
        <div className="mx-auto mb-12 max-w-custom text-center p-3 rounded-lg" style={{ height: '10vh' }}>
      ...
      <main>
        <div className="mx-auto mb-12 text-sm sm:text-base md:text-lg text-center p-8 rounded-lg"> 
          <CinetechAssistant 
